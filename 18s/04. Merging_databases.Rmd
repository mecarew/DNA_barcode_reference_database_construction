...
# remove NCBI duplicates with 'sp.' instead of taxonomic names
```{r}
...
all_db[all_db$id == '6360803', 'species'] <- 'Agapetus sp. B-ACN2227';
all_db[all_db$id == 'KX291413', 'species'] <- 'Agapetus sp. B-ACN2227';
all_db[all_db$id == 'KX291989', 'species'] <- 'Agapetus sp. B-ACN2227';
all_db[all_db$id == 'KX292033', 'species'] <- 'Agapetus sp. B-ACN2227';
all_db[all_db$id == 'KX294319', 'species'] <- 'Agapetus sp. B-ACN2227';
all_db[all_db$id == 'KX294720', 'species'] <- 'Agapetus sp. B-ACN2227';
all_db[all_db$id == '7864408', 'species'] <- 'Anax papuensis';
all_db[all_db$id == '7864411', 'species'] <- 'Austrolestes annulosus';
...
all_db[all_db$id == 'OQ281713', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ281725', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309202', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309210', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309225', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309233', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309235', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309244', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309263', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309278', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'OQ309286', 'species'] <- 'Chaetogaster diastrophus';
all_db[all_db$id == 'AY380495', 'species'] <- 'Cheumatopsyche sp. B-AAE9243';
all_db[all_db$id == 'AY380496', 'species'] <- 'Cheumatopsyche sp. B-AAE9243';
all_db[all_db$id == 'AY380497', 'species'] <- 'Cheumatopsyche sp. B-AAE9243';
...
all_db[all_db$id == '4410776', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'AY324046', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'AY324047', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'AY324051', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'AY324053', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'AY324055', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'AY324056', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'AY380490', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'AY380492', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
all_db[all_db$id == 'Co18Hydps3', 'species'] <- 'Cheumatopsyche sp. B-AAJ0493';
...
all_db[all_db$id == '4304131', 'species'] <- 'Chironomidae sp. B-ABA7848';
all_db[all_db$id == '8657541', 'species'] <- 'Chironomidae sp. B-ADC5579';
all_db[all_db$id == '8658142', 'species'] <- 'Chironomidae sp. B-ADC5579';
all_db[all_db$id == '8659050', 'species'] <- 'Chironomidae sp. B-ADC5579';
all_db[all_db$id == '8666060', 'species'] <- 'Chironomidae sp. B-ADC5579';
all_db[all_db$id == '3107202', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == '3107203', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == '4571653', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == '4575823', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == '4575824', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == '4575978', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == '4576059', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == '4603669', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == 'AY752677', 'species'] <- 'Cladopelma sp. B-AAD7362';
all_db[all_db$id == '4402309', 'species'] <- 'Coenoria sp. B-AAX3064';
all_db[all_db$id == '3900152', 'species'] <- 'Cognettia varisetosa';
all_db[all_db$id == '3900153', 'species'] <- 'Cognettia varisetosa';
all_db[all_db$id == '3096390', 'species'] <- 'Dero digitata';
all_db[all_db$id == 'AF534840', 'species'] <- 'Dero digitata';
all_db[all_db$id == 'GQ355368', 'species'] <- 'Dero digitata';
all_db[all_db$id == '8372736', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8372806', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8372835', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8372854', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8427930', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8428007', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8428604', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8428605', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8428668', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8428743', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8429263', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '8429641', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == 'T07755', 'species'] <- 'Dicranomyia sp. B-ADA2218';
all_db[all_db$id == '16874299', 'species'] <- 'Dicrotendipes sp. B-ACQ5956';
all_db[all_db$id == '16874522', 'species'] <- 'Dicrotendipes sp. B-ACQ5956';
all_db[all_db$id == '6855293', 'species'] <- 'Dicrotendipes sp. B-ACQ5956';
all_db[all_db$id == '6855295', 'species'] <- 'Dicrotendipes sp. B-ACQ5956';
all_db[all_db$id == '6855300', 'species'] <- 'Dicrotendipes sp. B-ACQ5956';
all_db[all_db$id == 'BCM14T3Orth1', 'species'] <- 'Dicrotendipes sp. B-ACQ5956';
all_db[all_db$id == '6233660', 'species'] <- 'Dinotoperla thwaitesi';
all_db[all_db$id == '2733459', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '3641580', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '3684190', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '3901591', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '3905141', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '4088164', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '9722859', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '9722895', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '9722927', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '9722938', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '9722972', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == '9723702', 'species'] <- 'Eiseniella tetraedra';
all_db[all_db$id == 'FC15ASDug1', 'species'] <- 'Girardia sp. MC-1';
all_db[all_db$id == 'FC15ASDug2', 'species'] <- 'Girardia sp. MC-1';
all_db[all_db$id == '10955370', 'species'] <- 'Kiefferulus intertinctus';
...
all_db[all_db$id == '6233934', 'species'] <- 'Koorrnonga sp. B-ABV9141';
all_db[all_db$id == '12916638', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == '4995320', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == '5112192', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == '5176824', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == '9528890', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == '9529230', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == '9529234', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == '9761237', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == 'KR759557', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == 'ME09Cr4', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == 'MF727341', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == 'MG143010', 'species'] <- 'Limnophyes sp. B-ABW2734';
all_db[all_db$id == '11304405', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '11412524', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '11440113', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '4456156', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '4456489', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '4478444', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '4492770', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '4493214', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '4493530', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '4525787', 'species'] <- 'Limnophyes sp. MC-A1';
all_db[all_db$id == '4819950', 'species'] <- 'Nais sp. B-AAF9652';
all_db[all_db$id == '4819959', 'species'] <- 'Nais sp. B-AAF9652';
all_db[all_db$id == '7697265', 'species'] <- 'Nais sp. B-AAF9652';
all_db[all_db$id == '2646383', 'species'] <- 'Nais sp. B-AAF9652';
all_db[all_db$id == '3358325', 'species'] <- 'Nais sp. B-AAF9652';
all_db[all_db$id == 'LN810253', 'species'] <- 'Nais sp. B-AAF9652';
all_db[all_db$id == '12918246', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == '6855368', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == '6855370', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == '6855372', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == '7210808', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == 'E06Po101', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == 'E06Po132', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == 'E06Po74', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == 'KJ946755', 'species'] <- 'Polypedilum sp. B-ACQ1511';
all_db[all_db$id == '7210840', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == '7210842', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == '7210843', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == '7210845', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == 'HQ248001', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == 'HQ248002', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == 'KJ946787', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == 'KJ946792', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == 'Pr117', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == 'Pr128', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == 'HQ248003', 'species'] <- 'Procladius sp. B-ACD4742';
all_db[all_db$id == 'HQ248004', 'species'] <- 'Procladius sp. B-ACD4742';
...
all_db[all_db$id == '5386250', 'species'] <- 'Spongillidae sp. B-AAJ0256';
all_db[all_db$id == '7214650', 'species'] <- 'Spongillidae sp. B-AAJ0256';
all_db[all_db$id == '8701402', 'species'] <- 'Spongillidae sp. B-AAJ0256';
all_db[all_db$id == '4569841', 'species'] <- 'Trinotoperla montana/minor/nivata';
all_db[all_db$id == '4569864', 'species'] <- 'Trinotoperla montana/minor/nivata';
all_db[all_db$id == '6233674', 'species'] <- 'Trinotoperla montana/minor/nivata';
all_db[all_db$id == 'Co18Grip12', 'species'] <- 'Trinotoperla montana/minor/nivata';
all_db[all_db$id == 'KU366085', 'species'] <- 'Trinotoperla montana/minor/nivata';
all_db[all_db$id == 'KY078198', 'species'] <- 'Trinotoperla montana/minor/nivata';
all_db[all_db$id == '4382986', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '4391595', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '4391617', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '4585637', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '6233858', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '6233859', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '6233860', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '6233861', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '6233862', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '6233863', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '6233864', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '6233865', 'species'] <- 'Ulmerophlebia sp. B-ABV4550';
all_db[all_db$id == '10690799', 'genus'] <- '';
all_db[all_db$id == '10691930', 'genus'] <- '';
all_db[all_db$id == '11708647', 'genus'] <- '';
all_db[all_db$id == '11708650', 'genus'] <- '';
all_db[all_db$id == '11708654', 'genus'] <- '';
all_db[all_db$id == '4126868', 'genus'] <- '';
all_db[all_db$id == '5386250', 'genus'] <- '';
all_db[all_db$id == '7214650', 'genus'] <- '';
all_db[all_db$id == '8701402', 'genus'] <- '';
all_db[all_db$id == '7864408', 'genus'] <- 'Anax';
all_db[all_db$id == '7864411', 'genus'] <- 'Austrolestes';
...
all_db[all_db$id == '4410776', 'genus'] <- 'Cheumatopsyche';
all_db[all_db$id == '3900152', 'genus'] <- 'Cognettia';
all_db[all_db$id == '3900153', 'genus'] <- 'Cognettia';
all_db[all_db$id == '3096390', 'genus'] <- 'Dero';
all_db[all_db$id == 'AF534840', 'genus'] <- 'Dero';
all_db[all_db$id == 'GQ355368', 'genus'] <- 'Dero';
all_db[all_db$id == '2733459', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '3641580', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '3684190', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '3901591', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '3905141', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '4088164', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '9722859', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '9722895', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '9722927', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '9722938', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '9722972', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '9723702', 'genus'] <- 'Eiseniella';
all_db[all_db$id == 'FER17Oligo4', 'genus'] <- 'Eiseniella';
all_db[all_db$id == 'FEROligo1', 'genus'] <- 'Eiseniella';
all_db[all_db$id == 'OL458180', 'genus'] <- 'Eiseniella';
all_db[all_db$id == 'OL458315', 'genus'] <- 'Eiseniella';
all_db[all_db$id == 'OL458337', 'genus'] <- 'Eiseniella';
all_db[all_db$id == 'OL458353', 'genus'] <- 'Eiseniella';
all_db[all_db$id == 'OL458571', 'genus'] <- 'Eiseniella';
all_db[all_db$id == '7697265', 'genus'] <- 'Nais';
all_db[all_db$id == '7864408', 'family'] <- 'Aeshnidae';
all_db[all_db$id == '3900152', 'family'] <- 'Enchytraeidae';
all_db[all_db$id == '3900153', 'family'] <- 'Enchytraeidae';
all_db[all_db$id == 'KX296496', 'family'] <- 'Hydropsychidae';
all_db[all_db$id == '7864411', 'family'] <- 'Lestidae';
all_db[all_db$id == '2733459', 'family'] <- 'Lumbricidae';
all_db[all_db$id == '3641580', 'family'] <- 'Lumbricidae';
all_db[all_db$id == '3684190', 'family'] <- 'Lumbricidae';
all_db[all_db$id == '3901591', 'family'] <- 'Lumbricidae';
all_db[all_db$id == '3905141', 'family'] <- 'Lumbricidae';
all_db[all_db$id == '4088164', 'family'] <- 'Lumbricidae';
all_db[all_db$id == '3096390', 'family'] <- 'Naididae';
all_db[all_db$id == 'AF534840', 'family'] <- 'Naididae';
all_db[all_db$id == 'GQ355368', 'family'] <- 'Naididae';
...
all_db[all_db$id == 'LIS417Oligo5', 'order'] <- 'Enchytraeida';
all_db[all_db$id == 'AF534840', 'order'] <- 'Tubificida';
all_db[all_db$id == 'GQ355368', 'order'] <- 'Tubificida';
...
all_db[all_db$id == '8665185', 'family'] <- 'Ceratopogonidae';
...
all_db[all_db$id == 'KX296496', 'species'] <- 'Cheumatopsyche sp. AV2';
...
all_db[all_db$id == '4400572', 'species'] <- 'Cheumatopsyche sp. AV2';
all_db[all_db$id == 'KX106950', 'species'] <- 'Cheumatopsyche sp. AV2';
...
all_db[all_db$id == '4402309', 'species'] <- 'Coenoria sp. B-AAX3064';
all_db[all_db$id == 'FJ263240', 'species'] <- 'Coenoria sp. B-AAX3064';
...
values_to_delete <- c("9045802", "6211936", "6211937", "7685744", "12440123", "4476585", "ON506903", "ON506899", "KP184905", "KP184906", "7730754", "7730753", "16869862", "8743451", "8664793", "8758551", "9047206", "9047213", "9038292", "MN226944", "4492196", "6692301", "7178169", "7372798", "8354237", "8769883", "FJ263240", "12862412", "MF739720")
...
```{r}
saveRDS(all_db, here::here("final_library/all_bold_priv_NCBI_final_clean_Feb24.rds"))
```
...
```{r}
# export group 1
export <- all_db2[1:200000, ] 

# save fasta          
refdb::refdb_export_dada2(export, here::here("18s/final_lib_export_18s_1.fasta"), mode = "taxonomy")

# remove files no longer needed


# export group 2
export2 <- all_db2[200001:400000, ] 

# save fasta 
refdb::refdb_export_dada2(export2, here::here("18s/final_lib_export_18s_2.fasta"), mode = "taxonomy")

# remove files no longer needed


# export group 3 (adjust final row number to match the final record number)
export3 <- all_db2[400001:668805, ] 

# save fasta 
refdb::refdb_export_dada2(export3, here::here("18s/final_lib_export_18s_3.fasta"), mode = "taxonomy")
...
trimmed_files <- c(
    paste0(output_dir, "18s/final_lib_export_18s_1.fasta"),
    paste0(output_dir, "18s/final_lib_export_18s_2.fasta"),
    paste0(output_dir, "18s/final_lib_export_18s_3.fasta")
)

# Output file to create
output_file <- paste0(output_dir, "18s/final_lib_export_18s.fasta")
