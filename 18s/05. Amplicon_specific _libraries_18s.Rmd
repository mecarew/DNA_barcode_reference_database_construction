...
```{r}
all_db <- readRDS(here::here("18s/conbimed_18s_ncbi_may24.txt"))
```
...
db_files <- c(
  "18s_db_2024-06" = "~/git/DNA_barcode_reference_database_construction/18s/all_db.fasta")
```

# Write all - write data as .txt files for taxonomic information and .fasta files with the sequence data
```{r}
output_dir <- "~/Documents/DNA_reference_db_construction_final_libraries/final_library"
