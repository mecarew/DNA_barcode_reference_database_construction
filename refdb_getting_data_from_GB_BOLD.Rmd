...
```{r}
write_rds(ncbi_data_clean,"~/Documents/DNA_reference_db_construction/refdb/refdb_output_data/NCBI_data_clean_Oct23.rds")
```

# importing cleaned NCBI GenBank data (if required)
```{r}
ncbi_data_clean <- readRDS("~/Documents/DNA_reference_db_construction/refdb/refdb_output_data/NCBI_data_clean_Oct23.rds")
```
...
```{r}
control <- read_csv("~/Documents/DNA_reference_db_construction/refdb/refdb_input_data/Control_spike.csv")
...
```{r}
write_rds(bold_data,"~/Documents/DNA_reference_db_construction/refdb/refdb_input_data/bold_data_oct23.rds")

# reload all BOLD document for cleaning (if needed)
#bold_data <- readRDS("~/Documents/DNA_reference_db_construction/refdb/refdb_input_data/bold_data_oct23.rds")
```
...
```{r}
saveRDS(bold_data_clean,"~/Documents/DNA_reference_db_construction/refdb/refdb_output_data/bold_data_clean_Oct23.rds")

# import cleaned BOLD data (if required)
#bold_data_clean <- readRDS("~/Documents/DNA_reference_db_construction/refdb/refdb_output_data/bold_data_clean_Oct23.rds")
```
...
```{r}
priv_lib <- read_csv ("~/Documents/DNA_reference_db_construction/refdb/refdb_input_data/priv_lib_Nov23.csv")
```
...
```{r}
saveRDS(priv_lib_clean, "~/Documents/DNA_reference_db_construction/refdb/refdb_output_data/priv_lib_Nov23_cleaned.rds")

# importing library into R (if required)
#priv_lib_clean <- readRDS("~/Documents/DNA_reference_db_construction/refdb/refdb_output_data/priv_lib_Nov23_cleaned.rds")
```
...
```{r}
saveRDS(all_bold_priv_ncbi,"~/Documents/DNA_reference_db_construction/refdb/refdb_output_data/all_bold_priv_NCBI_final_clean_Nov23.rds")

#read in if needed
#all_bold_priv_ncbi <- readRDS("~/Documents/DNA_reference_db_construction/refdb/refdb_output_data/all_bold_priv_NCBI_final_clean_Nov23.rds")
```
...
# save fasta 
refdb_export_dada2(export, "~/Documents/DNA_reference_db_construction/refdb/final_library/for_geneious/final_lib_export_nov23_1of3.fasta", mode = "taxonomy")
...
# save fasta 
refdb_export_dada2(export2, "~/Documents/DNA_reference_db_construction/refdb/final_library/for_geneious/final_lib_export_nov23_2of3.fasta", mode = "taxonomy")
...
# save fasta 
refdb_export_dada2(export3, "~/Documents/DNA_reference_db_construction/refdb/final_library/for_geneious/final_lib_export_nov23_3of3.fasta", mode = "taxonomy")
...
#fasta1 <- bioseq::read_fasta("~/Documents/DNA_reference_db_construction/refdb/for_geneiousfinal_library/final_lib_export_1.fasta")

#fasta2 <- bioseq::read_fasta("~/Documents/DNA_reference_db_construction/refdb/for_geneiousfinal_library/final_lib_export_2.fasta")

#fasta3 <- bioseq::read_fasta("~/Documents/DNA_reference_db_construction/refdb/for_geneiousfinal_library/final_lib_export_3.fasta")
...
#change column header from 'DNA_seq' to 'sequence' for futher analysis
