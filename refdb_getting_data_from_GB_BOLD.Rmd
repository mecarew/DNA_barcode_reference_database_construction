...
# records for deleting (wrong id's or incomplete taxonomy causes taxonomic assigment issues)
...
db_files <- c(
  ...
  "right_db_2023-07" = "~/git/DNA_barcode_reference_database_construction/final_library/right_amplicon_trimmed.fasta",
   "lco_db_2023-07" = "~/git/DNA_barcode_reference_database_construction/final_library/right_amplicon_trimmed.fasta")
```
