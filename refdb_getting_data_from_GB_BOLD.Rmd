...
# Step 5: Setting fields for BOLD data
```{r}
...
##Need more work (this is a library that would be used for DNA barcoding only)
#LCO amplicon
ampliconGroup=LCO
cutadapt \
    --cores 4 \
