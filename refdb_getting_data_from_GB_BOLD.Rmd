...
rows_with_empty_values <- all_bold_priv_ncbi[all_bold_priv_ncbi$id == "", , drop = FALSE]
# fix conrol samples and add name
#all_bold_priv_ncbi[5523131, "id"] <- "control"
```
...
# check cutadapt has been found (no errors reported)
```{bash}
...
```{r}
ampliconGroup <- "short"
output_dir <- "/mnt/galaxy/home/mecarew/git/DNA_barcode_reference_database_construction"
...
command <- paste(
    "cutadapt -g ACWGGWTGRACWGTNTAYCC...GCHGGDGCHATYACHATRYT -e 0.10 --revcomp -m 100 -M 450 --max-n 0.05",
    ...
    paste0(output_dir, "/final_library/all_db.fasta"),
    ">", log_file,
    collapse = " "
)
...
command <- paste(
    "cutadapt -g ACWGGWTGRACWGTNTAYCC...GCHGGDGCHATYACHATRYT -e 0.31 --revcomp -m 100 -M 450 --max-n 0.05",
...
output_file <- paste0(output_dir, "trimming/short_amplicon_trimmed.fasta")
...
# Construct and execute the Cutadapt command
command <- paste(
"cutadapt -g AACWGGWTGRACWGTNTAYCC...TGRTTYTTYGGNCAYCCHGA -e 0.3 --revcomp -m 200 -M 550 --max-n 0.05",
    "--too-short-output", paste0(trimming_dir, ampliconGroup, "_amplicon_too_short1.fasta"),
    "--too-long-output", paste0(trimming_dir, ampliconGroup, "_amplicon_too_long1.fasta"),
    "--untrimmed-output", paste0(trimming_dir, ampliconGroup, "_amplicon_untrimmed1.fasta"),
    "-o", paste0(trimming_dir, ampliconGroup, "_amplicon_trimmed1.fasta"),
...
command <- paste(
    "cutadapt -g ACWGGWTGRACWGTNTAYCC...TGRTTYTTYGGNCAYCCHGA -e 0.36 --revcomp -m 200 -M 550 --max-n 0.05",
    "--too-short-output", paste0(trimming_dir, ampliconGroup, "_amplicon_too_short2.fasta"),
    "--too-long-output", paste0(trimming_dir, ampliconGroup, "_amplicon_too_long2.fasta"),
    "--untrimmed-output", paste0(trimming_dir, ampliconGroup, "_amplicon_untrimmed2.fasta"),
    "-o", paste0(trimming_dir, ampliconGroup, "_amplicon_trimmed2.fasta"),
...
command <- paste(
    "cutadapt -g ACWGGWTGRACWGTNTAYCC...GCHGGDGCHATYACHATRYT -e 0.32 --revcomp -m 100 -M 450 --max-n 0.05",
    "--too-short-output", paste0(trimming_dir, ampliconGroup, "_amplicon_too_short3.fasta"),
    "--too-long-output", paste0(trimming_dir, ampliconGroup, "_amplicon_too_long3.fasta"),
    "--untrimmed-output", paste0(trimming_dir, ampliconGroup, "_amplicon_untrimmed3.fasta"),
    "-o", paste0(trimming_dir, ampliconGroup, "_amplicon_trimmed3.fasta"),
...
command <- paste(
    "cutadapt -g CCNGAYATRGCNTTYCC...CCNGTNYTNGCNGGNGCNATYACH -e 0.33 --revcomp -m 200 -M 450 --max-n 0.05 ",
    "--too-short-output", paste0(trimming_dir, ampliconGroup, "_amplicon_too_short2.fasta"),
    "--too-long-output", paste0(trimming_dir, ampliconGroup, "_amplicon_too_long2.fasta"),
    "--untrimmed-output", paste0(trimming_dir, ampliconGroup, "_amplicon_untrimmed2.fasta"),
    "-o", paste0(trimming_dir, ampliconGroup, "_amplicon_trimmed2.fasta"),
